document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormSuccess() {
      ...
      successEl.textContent = contactForm.getAttribute('data-success-message') || 'Your message has been sent successfully!';
      ...
      if (formAction && formAction !== '#') {
        ...
        fetch(formAction, {
          ...
          .catch(function () {
            ...
            errorEl.setAttribute('role', 'alert');
            errorEl.textContent = contactForm.getAttribute('data-error-message') || 'Something went wrong. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'aac44aa9-2a46-42e9-82e0-7b6eeac17701',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'aac44aa9-2a46-42e9-82e0-7b6eeac17701';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'aac44aa9-2a46-42e9-82e0-7b6eeac17701';
